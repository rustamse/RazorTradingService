...
namespace RazorCore.Tests
{
	...
	{
		[Test(Description = " огда истори€ из 1 элемента и дата построени€ после, то" +
							"¬озвращает единственный интервал (от начала истории и до времени расчета)")]
		...
		[Test(Description = " огда истори€ из 1 элемента и дата построени€ до, то" +
							"Ќе  возвращает интервалов")]
		...
		[Test(Description = " огда нет истории, то нет и результирующих интервалов.")]
		...
		[Test(Description = " огда истори€ за 2016,2017,2018 год, а дата расчета 2017 год, " +
