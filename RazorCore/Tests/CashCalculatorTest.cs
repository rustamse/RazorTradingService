...
namespace RazorCore.Tests
{
	...
	public class CashCalculatorTest
	{
		...
		[Test(Description = "≈сли подписка приостановлена посто€нно, то стоимость нулева€.")]
		...
		[Test(Description = "≈сли подписка приостановлена посто€нно, потом была, потом снова приостановлена, то стоимость будет равна одной доставке.")]
